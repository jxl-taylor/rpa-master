...
public final class DemoApplication extends WebFrame {
	...
	private void initializeDocks() {
		...
		final WebPanel overlayContainer = new WebPanel(DemoStyles.emptycontentPanel, new BorderLayout());
		...
		overlayContainer.add(graphEditor, BorderLayout.CENTER);
		...
		paletteFrame = new PaletteFrame(this);
		dockablePane.addFrame(paletteFrame);
	...
	public void updateTitle() {
		...
		// Library version
		title.append("MR-RPA ").append(version.toString());
