...
package com.alee.demo.frames.debug;
 ...
 * @author Mikle Garin
 */
public final class DebugFrame extends WebDockableFrame
{
    /**
     * Frame ID.
     */
    public static final String ID = "demo.debug";
     ...
     */
    public DebugFrame(@NotNull final DemoApplication application )
    {
        super ( StyleId.dockableframeCompact, ID, DemoIcons.inspector16, "demo.debug.title" );
